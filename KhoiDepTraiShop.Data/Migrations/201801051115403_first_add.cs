namespace KhoiDepTraiShop.Data.Migrations
{
    ...
    public partial class first_add : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MemuGroups", t => t.GroupId, cascadeDelete: true)
                .Index(t => t.GroupId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Menus", "GroupId", "dbo.MemuGroups");
