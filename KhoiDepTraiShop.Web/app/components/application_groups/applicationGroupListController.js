(function (app) {
    ...
    applicationGroupListController.$inject = ['$scope', 'apiService', 'notifyService', '$ngBootbox','$filter'];

    function applicationGroupListController($scope, apiService, notifyService, $ngBootbox, $filter) {
        $scope.loading = true;
        $scope.data = [];
        $scope.page = 0;
        $scope.pageCount = 0;
